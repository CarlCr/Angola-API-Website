...
module.exports = {
  siteMetadata: {
    title: `Angola API • Uma api  para frontend e backends`,
    description: `Cria sites e aplicativos poderosos com o Angola-API`,
    author: `@carlcr`,
  },
  plugins: [
    ...
    `gatsby-transformer-sharp`,
    {
      ...
      options: {
        name: `Angola API`,
        short_name: `Angola API`,
        start_url: `/`,
        background_color: `#1A1C1D`,
        theme_color: `#1A1C1D`,
        display: `standalone`,
        icon: `src/assets/images/logo-simples.png`,
      },
    },
