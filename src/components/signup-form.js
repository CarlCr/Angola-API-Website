...
export default function () {
  ...
  // state
  let convertKitUrl = "https://app.convertkit.com/forms/2125733/subscriptions"
    ...
    <FadeBetween state={didSignup}>
      {/* <State for={false}>
        <p className="text-sm text-white md:text-base">
          Subscreva-te para futuras actualizações.
        </p>
        <div className="mt-3">
          <form onSubmit={handleSubmit}>
            <div className="flex shadow-black">
              ...
              />
              <Button isRunning={isSaving}>Subscrever</Button>
            </div>
            {isError && (
              <div className="mt-5">
                {error === "serverError" &&
      ...
      <State for={true}>
        <p className="text-gray-500">
          Obrigado <span className="text-white">{email}</span>! Confira o seu e-mail
          o quanto antes
        </p>
      </State> */}
    </FadeBetween>
