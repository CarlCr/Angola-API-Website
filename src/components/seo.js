...
function SEO({ title, description, image, lang, meta }) {
  ...
  let defaultImage = `https://res.cloudinary.com/yetubrand/image/upload/v1616013591/angola-api/media-card_ikfpa1.png`
  ...
  return (
    <Helmet
      ...
      titleTemplate={title ? `%s • Angola API` : site.siteMetadata.title}
      meta={[
        {
          name: `description`,
